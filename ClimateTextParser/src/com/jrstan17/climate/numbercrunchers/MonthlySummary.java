...
public class MonthlySummary extends NumberCruncher {
	...
	public void fillSpreadsheet() {
		...
		String[] colHeaders = new String[] { "Date", "Maximum Temperature", "Minimum Temperature",
				"Average Temperature", "Average Temperature Departure", "Precipitation", "Snowfall", "Snow Depth" };
