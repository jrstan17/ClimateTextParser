...
public class DailyAlmanac extends NumberCruncher {
   ...
   private void formatStatCells() {
      ...
      // statRowStart).setFormatString(NO_DECIMAL_FORMAT);
      // sheet.getCellByPosition(2,
      // statRowStart).setFormatString(NO_DECIMAL_FORMAT);
      // sheet.getCellByPosition(5,
      // statRowStart).setFormatString(TWO_DECIMAL_FORMAT);
      // sheet.getCellByPosition(6,
      // statRowStart).setFormatString(ONE_DECIMAL_FORMAT);
      //
      // // Averages
      // int[] colNums = new int[] { 1, 2, 3, 4, 7 };
      // for (int i = 0; i < colNums.length; i++) {
      // sheet.getCellByPosition(colNums[i], statRowStart +
      // 1).setFormatString(ONE_DECIMAL_FORMAT);
      // }
      //
      // // Normals
      ...
      // if (colNums[i] != 5) {
      // sheet.getCellByPosition(colNums[i], statRowStart +
      // 2).setFormatString(ONE_DECIMAL_FORMAT);
      // } else {
      // sheet.getCellByPosition(colNums[i], statRowStart +
      // 2).setFormatString(TWO_DECIMAL_FORMAT);
      // }
      // }
      //
      // // Departures
      ...
      // if (colNums[i] != 5) {
      // sheet.getCellByPosition(colNums[i], statRowStart +
      // 3).setFormatString(ONE_DECIMAL_FORMAT);
      // } else {
      // sheet.getCellByPosition(colNums[i], statRowStart +
      // 3).setFormatString(TWO_DECIMAL_FORMAT);
      // }
      // }
      //
      // // Center Align
      ...
      // {
      // for (int col = 0; col < COLUMNS; col++) {
      // sheet.getCellByPosition(col,
      // row).setHorizontalAlignment(HorizontalAlignmentType.CENTER);
      //
      // if (row == statRowStart) {
      // Border line = new Border(Color.BLACK, 1, SupportedLinearMeasure.PT);
      // sheet.getCellByPosition(col, row).setBorders(CellBordersType.TOP,
      // line);
      // }
      // }
      // }
